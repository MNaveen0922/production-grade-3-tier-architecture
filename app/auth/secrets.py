...
SSM paths (created by Terraform modules/ssm/):
  ...
  /enterprise-supportupport/prod/config/orders_queue_url  → SQS_QUEUE_URL
  /enterprise-supportupport/prod/config/sns_topic_arn     → SNS_TOPIC_ARN
  /enterprise-supportupportupport/prod/config/assets_bucket     → S3_BUCKET
